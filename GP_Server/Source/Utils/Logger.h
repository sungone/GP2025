...
#define ENABLE_CONSOLE_LOG      ENABLE_LOGGING
#define ENABLE_CONSOLE_WARNING  1
#define ENABLE_CONSOLE_ERROR    1
#define ENABLE_CONSOLE_SEND_LOG ENABLE_LOGGING
#define ENABLE_CONSOLE_RECV_LOG ENABLE_LOGGING

#define ENABLE_FILE_LOG         ENABLE_LOGGING
#define ENABLE_FILE_WARNING     ENABLE_LOGGING
#define ENABLE_FILE_ERROR       ENABLE_LOGGING
#define ENABLE_FILE_SEND_LOG    ENABLE_LOGGING
#define ENABLE_FILE_RECV_LOG    ENABLE_LOGGING
