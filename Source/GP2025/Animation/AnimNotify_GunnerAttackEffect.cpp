...
#include "Animation/AnimNotify_GunnerAttackEffect.h"
...
void UAnimNotify_GunnerAttackEffect::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
